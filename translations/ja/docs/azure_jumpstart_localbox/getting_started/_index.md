...
![LocalBox アーキテクチャ ダイアグラムのスクリーンショット](./architecture.png)
...
![LocalBox ネスト仮想化のスクリーンショット](./nested_virtualization.png)
...
![Bicep ベースのデプロイ フロー ダイアグラムのスクリーンショット](./deployment_flow.png)
